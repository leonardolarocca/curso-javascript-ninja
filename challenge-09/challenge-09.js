...
(() => {
  ...
  */
  console.log( `O resultado da soma é: ${sum((a,b) => { return a+b; })}`);
  /*
  Agora declare outra variáveis chamadas `subtraction`, `multiplication`,
  `division` e `mod`, e atribua à elas `calculator`, passando números
  diferentes para cada chamada.
  */
  let subtraction = calculator(10,5);
  let multiplication = calculator(100,100);
  let division = calculator(10,2);
  let mod = calculator(10,8);
  ...
  */
  ...
  console.log(`O resultador da subtração é: ${subtraction((a,b) => {return a - b})}`);
  console.log(`O resultador da subtração é: ${multiplication((a,b) => {return a * b})}`);
  console.log(`O resultador da subtração é: ${division((a,b) => {return a / b})}`);
  console.log(`O resultador da subtração é: ${mod((a,b) => {return a % b})}`);
